...
export default function Checkout() {
  ...
  const { data: addressData, isLoading: loadingAddresses } =
    useGetAddressesQuery(undefined, { skip: !user });
  const { data: summary, isLoading: loadingSummary } =
    useGetCheckoutSummaryQuery(undefined, { skip: !user });
  ...
  if (loadingAddresses || loadingSummary) {
    return (
      <div className="px-6 py-16 text-text-muted">Loading checkout...</div>
    );
  }
      ...
      <div className="grid md:grid-cols-3 gap-8">
        ...
        <div className="md:col-span-2 space-y-8">
          ...
          <div>
            ...
            {!showNewAddressForm ? (
              ...
              <form
                ...
                className="mt-4 space-y-3 border border-border rounded-card p-4"
              >
                <input
                ...
                <button
                  type="submit"
                  className="bg-primary text-white px-4 py-2 rounded-default text-sm font-medium"
                >
                  Save Address
                </button>
              </form>
          ...
          <div>
            ...
            {couponMessage && (
              <p
                className={`text-sm mt-2 ${discount > 0 ? "text-success" : "text-error"}`}
              >
                {couponMessage}
              </p>
            )}
        ...
        {/* Right: order summary */}
        <div className="border border-border rounded-card p-5 h-fit shadow-md bg-background sticky top-6">
          ...
          <button
            ...
            className="w-full bg-primary hover:bg-primary-hover text-white py-3.5 rounded-default font-semibold mt-6 shadow-lg shadow-primary/20 hover:shadow-xl transition-all"
          >
            Proceed to Payment
          </button>
        </div>
