...
export default function AdminProductForm() {
  ...
  const { data: productsData } = useGetProductsQuery({ limit: "50" }, { skip: !isEditMode })
    ...
    <div className="px-6 py-10 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          {imageUrl && (
            <img src={imageUrl} alt="Preview" className="w-24 h-24 object-cover rounded-default mt-2" />
          )}
        </div>
        ...
        >
          {creating || updating ? "Saving..." : isEditMode ? "Update Product" : "Create Product"}
        </button>
      </form>
    </div>
  )
