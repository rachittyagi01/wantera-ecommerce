...
export default function Cart() {
  ...
  return (
    <div className="px-6 py-10 max-w-4xl mx-auto">
        ...
        {items.map((item) => {
          ...
          return (
            <div
              ...
              className="flex items-center gap-4 border border-border rounded-card p-4 hover:shadow-sm transition-shadow bg-background"
            >
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="w-8 h-8 border border-border rounded-full hover:bg-primary hover:text-white hover:border-primary transition-colors flex items-center justify-center"
                >
                  −
                </button>
      ...
      <Link
        to="/checkout"
        className="block w-full text-center bg-primary hover:bg-primary-hover text-white py-3.5 rounded-default font-semibold mt-6 shadow-lg shadow-primary/20 hover:shadow-xl transition-all"
      >
        Proceed to Checkout
      </Link>
    </div>
